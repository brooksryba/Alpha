...
public class StatePlayerStart : StateMachineBehaviour
{
    ...
    override public void OnStateEnter(Animator animator, AnimatorStateInfo stateInfo, int layerIndex)
    {
        ...
        _manager.battleSystemHud.disableUnusableHuds(_manager.condition.attackerID, _manager.condition.playerParty);
    ...
    override public void OnStateUpdate(Animator animator, AnimatorStateInfo stateInfo, int layerIndex)
    {
        ...
        if(_manager.battleSystemHud.selection != null && 
           _manager.battleSystemHud.selection.characterID == _manager.condition.attackerID){
